...
- **「快出片」当前预发基线（2026-08-11）**：AIStar clip 为 `3560b942-20260811T170602Z`（v0.126、force-mock=false、active/running、`NRestarts=0`）；军师真机 server 包为 `385c863`，API 固定 `https://wxapi.aibuzz.cn/api_preprod`。后续回归不得拿 mock 包冒充本人素材验收。
