...
export async function adminRoutes(app: FastifyInstance) {
  ...
  app.get<{ Params: { key: string } }>('/admin/agents/:key', async (req, reply) => {
    ...
    return {
      ...
      deliverableKey: a.deliverableKey, greet: a.greet, memText: a.memText, learnText: a.learnText,
    ...
    async (req, reply) => {
      ...
      const a = await prisma.agent.update({
        ...
        data: {
          ...
          // 只有计费方式本身发生更新时才联动 gift；文案等窄字段 PATCH 不得顺带重写权益字段。
          gift: billing === undefined ? undefined : targetBilling === 'free',
          billing,
          ...
          memText: typeof b.memText === 'string' && b.memText.trim() ? b.memText : undefined,
          learnText: typeof b.learnText === 'string' && b.learnText.trim() ? b.learnText : undefined,
      ...
      await recordAudit({
        ...
        payload: {
          ...
          greetChanged: typeof b.greet === 'string',
          memTextChanged: typeof b.memText === 'string',
          learnTextChanged: typeof b.learnText === 'string',
