...
export interface GenContext {
  ...
  understanding?: string[];   // 「经营底稿」：真实档案/记忆/项目/知识沉淀的结构化理解
...
const RUNTIME_BUSINESS_GUARD = [
  ...
  '客户事实只能来自企业档案、经营底稿、长期记忆、当前项目、用户显式引用资料、知识库召回和本轮用户原文；不得编造客户公司、创业经历、规模、融资、客户、竞品、数据或困难。',
