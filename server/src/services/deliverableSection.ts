// 报告 V2 最小防线（服务端版，对齐 app/src/services/deliverableSection.ts）：把 12 种类型化
// section（hero/callout/stats/roster/table/phases/timeline/quote/letter/gauge/matrix/gantt）
// 降级成任意「读 h/b/list」的旧版消费方都能用的 {h,b?,list?}。
//
