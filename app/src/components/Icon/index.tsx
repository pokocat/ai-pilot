...
const PATHS: Record<string, string> = {
  ...
  conversation: '<path d="M16 10a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 14.286V4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/><path d="M20 9a2 2 0 0 1 2 2v10.286a.71.71 0 0 1-1.212.502l-2.202-2.202A2 2 0 0 0 17.172 19H10a2 2 0 0 1-2-2v-1"/>',
  ...
  // 图籍（2026-08-12 IA 重排新增）：两册线装书叠放 + 装订线 + 一枚封印。
  // 原来图籍借用点兵的 muster（打勾名册），语义是「点检」不是「档案」；这枚才是萧何收的那批册子。
  codex: '<rect x="4.8" y="7.2" width="14.4" height="5.2" rx="1.2"/><rect x="4.8" y="13.6" width="14.4" height="5.2" rx="1.2"/><path d="M8.3 7.2v5.2"/><path d="M8.3 13.6v5.2"/><circle cx="15.6" cy="9.8" r=".85" fill="CCC" stroke="none"/>',
