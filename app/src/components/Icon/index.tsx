...
const PATHS: Record<string, string> = {
  ...
  hat: '<path d="M6 16.5c0-5.2 2.2-9.7 6-9.7s6 4.5 6 9.7"/><path d="M9 9.8v6.7M12 8.6v7.9M15 9.8v6.7"/><path d="M5.5 16.5h13"/><path d="M10.3 16.5 12 19 13.7 16.5"/><path d="M15.4 7.1a1.5 1.5 0 1 1-.95 2.1"/>',
