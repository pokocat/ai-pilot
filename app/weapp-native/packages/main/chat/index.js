...
Page({
  ...
  onLoad(options) {
    ...
    this._agentKey = options.agentKey || 'general';
    this._projectId = options.projectId || '';
    this._continue = options.continue === '1' && options.fresh !== '1';
    this._refs = [];
    this._pendingPrompt = options.send ? decodeOption(options.send) : decodeOption(options.prompt);
