...
function card(ctx, w, h, data) {
  ...
  centerText(ctx, '你的生意，值得有人陪你想一遍', cx, 162, 24, GOLD);
  ...
  if (data.qr) {
    ...
    centerText(ctx, '微信扫码，直接开始', cx, boxY + boxW + 54, 26, INK);
  ...
  centerText(ctx, '获客贵 · 现金流紧 · 招人难 · 下一步押哪里', cx, h - 76, 24, CREAM);
  centerText(ctx, `${data.slotLabel} · 军师参谋部`, cx, h - 34, 22, GOLD);
}
