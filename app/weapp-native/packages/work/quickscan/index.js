...
Page(withShare({
  ...
  onShareAppMessage() { return { title: this.data.result ? `军师速诊：${this.data.result.contradiction}` : '3 个问题，10 分钟拿到你的初诊 · 军师参谋部', path: pathWithCode('/packages/work/quickscan/index') }; },
