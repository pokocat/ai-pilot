 ...
 */
const BUILTIN_COPY = [
  // 每条都必须是**完整闭环**：钩子（说中处境）+ 召唤（告诉他来干什么）。
  //
  // 2026-08-20 第二次重写的原因：上一版只做了「说中痛点」，没有行动召唤——
  // 「生意还行，但说不清下一年靠什么增长」摆完就断了，看的人不知道下一步该做什么，
  // 分享卡的唯一文案位（图上刻意无字）等于只用了一半。
  //
  // 长度：微信在聊天流里约两行、超出截断，测试钉 ≤30 字，实际都压在 24 字内保证显示完整。
  // 召唤词刻意换着说（问问军师 / 找军师拆一遍 / 摆给军师看 / 让军师算一算），
  // 12 条清一色「来问军师」会像群发广告。
  // 仍然：不承诺收益数字（合规）、不用「攻守/运势」这类盘面黑话。

  // ── 获客与转化 ──
  { title: '客户越来越贵？先问问军师钱漏在哪一环',
    timelineTitle: '获客成本涨不停，来让 AI 军师帮你查漏' },
  { title: '流量不缺、成交不够，找军师拆一遍漏斗',
    timelineTitle: '来的人多成的少？AI 军师帮你找断点' },
  { title: '老客户不回头，先让军师看看是哪步凉的',
    timelineTitle: '复购掉下来别急着加投放，先问问军师' },

  // ── 现金流与成本 ──
  { title: '利润表好看、账上没钱？让军师算一算',
    timelineTitle: '有利润没现金，这笔账该找 AI 军师算清' },
  { title: '成本年年涨，来问军师该先砍哪一刀',
    timelineTitle: '降本别乱砍，先让 AI 军师给个顺序' },

  // ── 用人与团队 ──
  { title: '招人难留人更难？把用人这事摆给军师',
    timelineTitle: '团队带不动，来问问 AI 军师问题在哪' },
  { title: '事都压在自己身上，找军师帮你分个轻重',
    timelineTitle: '老板忙到没空思考？让 AI 军师替你梳一遍' },

  // ── 方向与决策 ──
  { title: '说不清明年靠什么增长？来找军师问策',
    timelineTitle: '明年靠什么增长，值得找 AI 军师聊一次' },
  { title: '要扩还是要收，先摆给军师算笔账',
    timelineTitle: '扩张还是收一收？先让 AI 军师算笔账' },
  { title: '一件事拖着不敢定，来让军师帮你定',
    timelineTitle: '拖着不决定的事在悄悄收费，来问军师' },

  // ── 全局与陪伴 ──
  { title: '天天救火没人看全局？军师陪你看一遍',
    timelineTitle: '每天在救火，来找 AI 军师陪你看全局' },
  { title: '10 分钟，让军师把你最头疼的事拆成三步',
    timelineTitle: '10 分钟，AI 军师帮你把难题拆成三步' },
];
