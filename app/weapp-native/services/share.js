 ...
 */
const BUILTIN_COPY = [
  // 钩子的四种打法（2026-08-20 重写）：
  //   ① 反常识判断——先给一个和直觉相反的结论，逼人想「为什么」；
  //   ② 具体数字——比形容词可信，也比形容词更勾人；
  //   ③ 未完成的话——把结论留在点开之后；
  //   ④ 精准描述处境——让人觉得「这说的就是我」，比讲道理有效。
  // 刻意避开的：不用「先…」「值得…」这类雷同句式（12 条扫过去会像同一句），
  // 不承诺收益数字（合规），不用「攻守/运势」这类盘面黑话（对经商的人没代入感）。

  // ── 反常识 ──
  { title: '客户越来越贵，多半不是因为你投得少',
    timelineTitle: '获客成本涨上去，加预算往往是最贵的解法' },
  { title: '利润表好看，账上没钱——这中间有笔账没算',
    timelineTitle: '有利润却没现金，问题通常不在销售端' },
  { title: '员工不是不想干，是不知道干成什么样算好',
    timelineTitle: '团队没劲头，八成不是钱的问题' },

  // ── 具体数字 ──
  { title: '10 分钟，把你最头疼的那件事拆成三步',
    timelineTitle: '10 分钟，把一件想不清的事拆开看' },
  { title: '三个问题，先看出你的生意卡在哪一环',
    timelineTitle: '三个问题，找出最该动的那一环' },

  // ── 未完成 ──
  { title: '同行悄悄在改的那件事，你可能还没注意',
    timelineTitle: '你的同行今年在改什么？值得看一眼' },
  { title: '有件事拖着不决定，成本比做错还高',
    timelineTitle: '拖着不决定的那件事，正在悄悄收费' },
  { title: '下一步押哪里——先把牌摊开算一遍',
    timelineTitle: '要扩还是要收，先把账摊开算清' },

  // ── 精准处境 ──
  { title: '事都压在自己身上，忙到没空想「该往哪走」',
    timelineTitle: '老板忙到没空思考，这本身就是要解的题' },
  { title: '生意还行，但说不清下一年靠什么增长',
    timelineTitle: '说不清明年靠什么增长，就该坐下来算一算' },
  { title: '每天在救火，没人陪你看全局',
    timelineTitle: '天天救火的时候，最缺的是一个旁观者' },
  { title: '你身边未必有人能听懂这些难处',
    timelineTitle: '有些经营上的难处，跟谁都不好开口' },
];
