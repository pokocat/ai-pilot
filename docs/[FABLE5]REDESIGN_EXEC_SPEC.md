...
> 编写日期 2026-07-04
> ⚠️ **2026-07-11 决策覆盖**：本篇与 `[FABLE5]DECISIONS_2026-07-11.md` 冲突处以后者为准。要点：**WO-02 作废**（保留货架，多入口+来源归因）；WO-04 军师收编恢复执行（4+1）；WO-12 漏斗改多来源对比；WO-13 export 改授权拉取暂缓。落地现状核查见 `[FABLE5]REVIEW_2026-07-11.md`。
